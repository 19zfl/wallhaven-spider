...
public class WallhavenSpider {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WallhavenSpider v2 = new WallhavenSpider();
        // 自定义开始页数
        int id = 1;
        // 自定义类型, 类型查看官网
        String type = "random";
    ...
    public void getImgUrl(String url, int id) {
        ...
        try {
            ...
            for (Element element : img) {
                ...
                if (src.endsWith(".png")) {
                    OutputStream outputStream = new FileOutputStream("D:\\doc\\img\\wallhaven\\" + id + ".png");
                    IOUtils.copy(inputStream, outputStream);
                    System.out.println(id + ".png写入完毕");
                } else {
                    OutputStream outputStream = new FileOutputStream("D:\\doc\\img\\wallhaven\\" + id + ".jpg");
                    IOUtils.copy(inputStream, outputStream);
